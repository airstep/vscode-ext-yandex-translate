...
export class Configuration {
    ...
    public languages = ["af","ar","az","be","bg","bs","ca","cs","cy","da","de","el","en","es","et","eu","fi","fr","ga","gl","he","hr","ht","hu","hy","id","is","it","ka","kk","ky","la","lt","lv","mg","mk","mn","ms","mt","nl","no","pl","pt","ro","ru","sk","sl","sq","sr","sv","sw","tg","tl","tr","tt","udm","uk","uz","vi"];
    ...
    public combinations = ["en-ru","ru-en","en-uk","uk-en","uk-ru","ru-uk","en-es","en-it","tr-en","tr-ru","be-ru","bg-ru","cs-en","cs-ru","da-en","da-ru","de-en","de-ru","de-tr","el-en","el-ru","en-cs","en-da","en-de","en-el", "en-et","en-fi","en-fr","en-lt","en-lv","en-nl","en-no","en-pt","en-sk","en-sv","en-tr","es-en","es-ru","et-en","et-ru","fi-en","fi-ru","fr-en","fr-ru","it-en","it-ru","lt-en","lt-ru","lv-en","lv-ru","nl-en","nl-ru","no-en","no-ru","pl-ru","pt-en","pt-ru","ru-be","ru-bg","ru-cs","ru-da","ru-de","ru-el","ru-es","ru-et","ru-fi","ru-fr","ru-it","ru-lt","ru-lv","ru-nl","ru-no","ru-pl","ru-pt","ru-sk","ru-sv","ru-tr","ru-tt","sk-en","sk-ru","sv-en","sv-ru","tr-de","tt-ru"];
